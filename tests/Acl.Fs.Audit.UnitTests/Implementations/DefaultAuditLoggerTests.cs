...
public class DefaultAuditLoggerTests
{
    ...
    public async Task LogAsync_Should_CallILoggerWithExpectedParameters()
    {
        ...
        var entry = new AuditEntry(now, "TestCat", "TestMsg", 123, new Dictionary<string, object?> { { "k", "v" } });
        ...
        loggerMock.Verify(l => l.Log(
            ...
            It.Is<It.IsAnyType>((v, t) =>
                v.ToString()!.Contains("[AUDIT]") && v.ToString()!.Contains("TestCat") && v.ToString()!.Contains("TestMsg") && v.ToString()!.Contains("123") && v.ToString()!.Contains("k=v")),
            null,
