...
namespace Acl.Fs.Core.IntegrationTests.Service.Encryption.ChaCha20Poly1305;
...
public sealed class EncryptionServiceTests : IDisposable
{
    ...
    public async Task EncryptFileAsync_WithValidInputs_ShouldEncryptFileSuccessfully()
    {
        ...
        const string testContent = "This is a test file content for encryption testing with ChaCha20Poly1305.";
