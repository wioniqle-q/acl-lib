...
using Acl.Fs.Core.Service.Encryption.XChaCha20Poly1305;
using Microsoft.Extensions.Logging;
using Moq;
using static Acl.Fs.Constant.Cryptography.CryptoConstants;

namespace Acl.Fs.Core.UnitTests.Service.Encryption.XChaCha20Poly1305;
...
public sealed class EncryptionServiceTests : IDisposable
{
    ...
    public EncryptionServiceTests()
    {
        ...
        _tempDirectory = Path.Combine(Path.GetTempPath(), "AclFsTests", "XChaCha20Poly1305EncryptionService",
    ...
    public async Task EncryptFileAsync_GeneratesUniqueNonceForEachCall()
    {
        ...
        var input2 = new XChaCha20Poly1305EncryptionInput(encryptionKey2);
        ...
        Assert.All(capturedNonces, nonce => Assert.Equal(XChaCha20Poly1305NonceSize, nonce.Length));
