...
namespace Acl.Fs.Core.UnitTests.Models.XChaCha20Poly1305;

public sealed class XChaCha20Poly1305DecryptionInputTests
{
    [Fact]
    public void Constructor_WithValidPassword_ShouldCreateInstance()
    {
        ...
        var input = new XChaCha20Poly1305DecryptionInput(passwordMemory);
    ...
    public void Constructor_WithEmptyPassword_ShouldThrowArgumentException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() =>
            new XChaCha20Poly1305DecryptionInput(emptyPassword));
    ...
    public void Constructor_WithNullByteArrayPassword_ShouldThrowArgumentException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() =>
            new XChaCha20Poly1305DecryptionInput(passwordMemory));
    ...
    public void Equality_WithSamePassword_ShouldBeEqual()
    {
        ...
        var input1 = new XChaCha20Poly1305DecryptionInput(passwordMemory1);
        var input2 = new XChaCha20Poly1305DecryptionInput(passwordMemory2);
