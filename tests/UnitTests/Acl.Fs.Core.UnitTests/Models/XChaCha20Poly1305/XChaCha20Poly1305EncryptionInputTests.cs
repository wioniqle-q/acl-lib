...
public sealed class XChaCha20Poly1305EncryptionInputTests
{
    [Fact]
    public void Constructor_WithValidPassword_ShouldCreateInstance()
    {
        ...
        var input = new XChaCha20Poly1305EncryptionInput(passwordMemory);
    ...
    public void Constructor_WithEmptyPassword_ShouldThrowArgumentException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() =>
            new XChaCha20Poly1305EncryptionInput(emptyPassword));
    ...
    public void Constructor_WithNullByteArrayPassword_ShouldThrowArgumentException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() =>
            new XChaCha20Poly1305EncryptionInput(passwordMemory));
    ...
    public void Equality_WithSamePassword_ShouldBeEqual()
    {
        ...
        var input1 = new XChaCha20Poly1305EncryptionInput(passwordMemory1);
        var input2 = new XChaCha20Poly1305EncryptionInput(passwordMemory2);
