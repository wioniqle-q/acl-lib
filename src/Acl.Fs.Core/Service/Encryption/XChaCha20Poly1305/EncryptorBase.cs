    ...
    : IEncryptorBase
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var algorithm = _xChaCha20Poly1305Factory.Create(keyPreparation.DerivedKey.ToArray());
            using var cryptoKey = Key.Import(algorithm, keyPreparation.DerivedKey.ToArray(),
