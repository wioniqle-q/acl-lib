...
internal static class LogMessages
{
    ...
    internal const string PosixFadviseSequentialFailed = "PosixFadvise Sequential failed with error {ErrorCode} for file length {Length}";
    internal const string PosixFadviseDontNeedFailed = "PosixFadvise DontNeed failed with error {ErrorCode} for file length {Length}";
}