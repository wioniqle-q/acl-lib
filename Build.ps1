...
$SampleProjects = @(
    ...
    "samples/Acl.Fs.ChaCha20Poly1305.Sample/Acl.Fs.ChaCha20Poly1305.Sample.csproj",
    "samples/Acl.Fs.XChaCha20Poly1305.Sample/Acl.Fs.XChaCha20Poly1305.Sample.csproj",
    "samples/Acl.Fs.Cli/Acl.Fs.Cli.csproj"
)
$SourceProjects = @(
    "src/Acl.Fs.Constant/Acl.Fs.Constant.csproj",
